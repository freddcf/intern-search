...
<body>
  <div class="container">
    <div class="tela-cad">
      <form action="cadastroCandidato-form.php" method="post" class="login">
        <h1 class="welcome">Cadastrar-se como candidato</h1>
        ...
        <input type="text" name="contato" id="contato" onkeyup="maskNum(event)" placeholder="Contato" >
